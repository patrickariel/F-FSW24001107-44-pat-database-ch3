...
export const ProductScalarFieldEnumSchema = z.enum(['id','name','manufacturer','weight','added','department','price','stock','images','description','userId']);
...
export const ProductOrderByRelevanceFieldEnumSchema = z.enum(['id','name','manufacturer','department','images','description','userId']);
